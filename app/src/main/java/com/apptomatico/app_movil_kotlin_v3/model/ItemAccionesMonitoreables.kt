...
class ItemAccionesMonitoreables{
    ...
    var redNegocio: List<RedEstatusServer>? = null
    var esFavorito: Boolean? = null
    var fecUltAct: String? = null
    var idEquipo: Int? = null

    constructor(id_movil: Int, idaccion: Int, origen: Int, comando: String, accion: String, porcentaje: String, total_usado: String, espacio_libre: String, paquetes_enviados: String, paquetes_recibidos: String, nomServidor: String, redNegocio:List<RedEstatusServer>?, esFavorito: Boolean, fecUltAct: String, idEquipo: Int){
