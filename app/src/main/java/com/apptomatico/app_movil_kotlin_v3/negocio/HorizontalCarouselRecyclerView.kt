...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.colorPrimario) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.colorSecundario) }
                ...
                post {
                    ...
                    try {
                        ...
                        if (childCount == 1){
                            ...
                            setPadding((width/childCount).toInt() - (getChildAt(0).width / childCount), 0, sidePadding, 0)
                        }
    ...
    private fun onScrollChanged() {
        post {
            (0 until childCount).forEach { position ->
                ...
                val scaleValue = getGaussianScale(childCenterX, 1f, 1f, 1.toDouble())
